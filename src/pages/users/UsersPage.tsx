      ...
      <div className="flex-1 overflow-auto px-8 py-4">
        {loading ? (
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {users.map((u, i) => (
                <tr key={u.id} className={`border-b border-border/50 hover:bg-muted/20 transition-colors group ${i % 2 === 0 ? "" : "bg-card/30"}`}>
                  ...
                  <td className="text-start py-3.5 px-3 font-medium text-foreground">{u.fullname}</td>
                  <td className="text-start py-3.5 px-3 font-mono text-xs text-muted-foreground"><span dir="ltr" className="inline-block">{u.phonenumber || "—"}</span></td>
                  <td className="text-start py-3.5 px-3">
                  ...
                  <td className="text-start py-3.5 px-3 font-mono text-xs text-muted-foreground"><span dir="ltr" className="inline-block">{formatDate(u.dateofcreation)}</span></td>
