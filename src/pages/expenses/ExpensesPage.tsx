      ...
      <div className="w-full max-w-sm bg-card border border-border rounded-2xl shadow-2xl p-6 space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              type="submit" disabled={loading || !description.trim() || !amount}
      ...
      <div className="flex-1 overflow-auto px-8 py-4">
        {loading ? (
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {expenses.map((e, i) => (
                <tr key={e.id} className={`border-b border-border/50 hover:bg-muted/20 transition-colors group ${i % 2 === 0 ? "" : "bg-card/30"}`}>
                  ...
                  <td className="text-start py-3.5 px-3 text-foreground max-w-xs">{e.description}</td>
                  <td className="text-start py-3.5 px-3 font-mono text-sm font-semibold text-rose-600 dark:text-rose-400"><span dir="ltr" className="inline-block">${e.amount.toLocaleString()}</span></td>
                  <td className="text-start py-3.5 px-3 text-xs text-muted-foreground">{e.accountantname}</td>
                  <td className="text-start py-3.5 px-3 font-mono text-xs text-muted-foreground whitespace-nowrap"><span dir="ltr" className="inline-block">{formatDate(e.createdat)}</span></td>
