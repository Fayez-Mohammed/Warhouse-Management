            ...
            <div className="w-full max-w-2xl bg-card border border-border rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
                        ...
                        {rows.map((row, i) => (
                            <div key={i} className="grid grid-cols-5 gap-2 items-end p-3 bg-muted/30 rounded-xl border border-border/50">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <input value={row.reason} onChange={e => updateRow(i, "reason", e.target.value)} required placeholder={t("placeholder_reason")} className={inputCls} />
                                </div>
                    ...
                    <div className="flex gap-3 px-6 py-4 border-t border-border shrink-0">
                        <button type="button" onClick={onClose} className="flex-1 border border-border text-muted-foreground hover:text-foreground rounded-lg py-2.5 text-sm font-medium transition-all">
                            {t("btn_cancel")}
                        </button>
                        <button
                            type="submit"
